...
class Profile(models.Model):
    ...
    state = models.CharField(max_length=209, blank = True)
...
class ImageForLogo(models.Model):
...
class ImageForCover(models.Model):
    poster_name = models.CharField(max_length=50)
    image = models.ImageField(upload_to='upload/covers/')
...
class Order(models.Model):
    ...
    size=models.ForeignKey(Product_Size, on_delete=models.CASCADE, blank=True, null=True)
